...
class EditController extends FrontController
{
    ...
    public function commonQueries()
    {
        ...
        // Get Post Types
        $data['packages'] = \DB::table('packages')->pluck('name','id');
        view()->share('packages', $data['packages']);

        // Get Statess Types
        $data['subadmin1'] = SubAdmin1::pluck('name','id');
        view()->share('subadmin1', $data['subadmin1']);

        // Get districts Types
        $data['subadmin2'] = SubAdmin2::pluck('name','id');
        view()->share('subadmin2', $data['subadmin2']);
