			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						...
						<li><a href="{{ url($adminBase . '/companies') }}"><i class="fa fa-institution"></i> <span>{{ trans('admin::messages.companies') }}</span></a></li>
						<li><a href="{{ url($adminBase . '/p_types') }}"><i class="fa fa-cog"></i> <span>{{ trans('admin::messages.ad types') }}</span></a></li>
						<li><a href="{{ url($adminBase . '/salary_types') }}"><i class="fa fa-cog"></i> <span>{{ trans('admin::messages.salary type') }}</span></a></li>
					</ul>
				</li>
